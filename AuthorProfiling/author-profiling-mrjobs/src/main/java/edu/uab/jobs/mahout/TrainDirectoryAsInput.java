...
public class TrainDirectoryAsInput {

	public TrainDirectoryAsInput() {
	}
...
//				.learningRate(20);
		 ...
		 AdaptiveLogisticRegression learningAlgorithm = new AdaptiveLogisticRegression(30, NewsgroupHelper.FEATURES, new L1());
...
//		}
		...
		ModelSerializer.writeBinary("/tmp/author_profile_logistic.model", learningAlgorithm
