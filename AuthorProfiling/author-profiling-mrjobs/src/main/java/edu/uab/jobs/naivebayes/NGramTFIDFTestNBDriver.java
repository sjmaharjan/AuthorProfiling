 ...
 * To change this template use File | Settings | File Templates.
 */
public class NGramTFIDFTestNBDriver extends Configured implements Tool {
    private static final Logger log = LoggerFactory.getLogger(TestNBTFIDFDriver.class);
...
//        }
        ...
        job.setJobName("Test NGram NB TFIDF   ");
        job.setJarByClass(NGramTFIDFTestNBDriver.class);
        ...
        job.setMapperClass(NGramTFIDFTestNBMapper.class);
    ...
    public static void main(String args[]) throws Exception {
        NGramTFIDFTestNBDriver testRunner = new NGramTFIDFTestNBDriver();
