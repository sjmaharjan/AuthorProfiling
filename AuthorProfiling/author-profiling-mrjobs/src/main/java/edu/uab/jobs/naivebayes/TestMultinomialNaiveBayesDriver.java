 ...
 */
public class TestMultinomialNaiveBayesDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(TestMultinomialNaiveBayesDriver.class);
        ...
        job.setMapperClass(MultinomialNaiveBayesTestMapper.class);
    ...
    public static void main(String args[]) throws Exception {
        TestMultinomialNaiveBayesDriver testRunner = new TestMultinomialNaiveBayesDriver();
