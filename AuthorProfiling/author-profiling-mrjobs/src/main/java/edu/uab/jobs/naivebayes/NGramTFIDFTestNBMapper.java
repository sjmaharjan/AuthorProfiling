 ...
 */
public class NGramTFIDFTestNBMapper extends Mapper<Text, Text, Text, VectorWritable> {
    private static final Logger log = LoggerFactory.getLogger(TestNBTFIDFMapper.class);
