 ...
 */
public class NGramTokenizerDriver extends Configured implements Tool {
    @Override
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(NGramTokenizerDriver.class);
        ...
        job.setMapperClass(NGramTokenizerMapper.class);
    ...
    public static void main(String args[]) throws Exception {
       int exitCode= ToolRunner.run(new NGramTokenizerDriver(),args);
